			...
			<div class="login_form fl">
				...
				<form  method="post" id="login">
					...
					<ul>
						<li>
							<label for="">用户名：</label>
							<input type="text" class="txt" name="UserForm[username]" id="username" />
						</li>
						<li>
							<label for="">密码：</label>
							<input type="password" class="txt" name="UserForm[password]" id="password" />
							<a href="">忘记密码?</a>
						</li>
						<li class="checkcode">
							<label for="">验证码：</label>
							<input type="text"  name="UserForm[checkcode]" id="checkcode"/>
							<img src="/user/code" alt=""  id="checkcodeimg"/>
							<span>看不清？<a href="javascript:void (0)" id="checkcodes">换一张</a></span>
						</li>
						<li>
							<label for="">&nbsp;</label>
							<input type="checkbox" class="chb" name="UserForm[rememberMe]"  checked="checked"/> 保存登录信息
						</li>
						<li>
							<label for="">&nbsp;</label>
