    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl <?=Yii::$app->controller->id."/".Yii::$app->controller->action->id==="index/index"?"":"cat1"?>"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd <?=Yii::$app->controller->id."/".Yii::$app->controller->action->id==="index/index"?"":"none"?>">
                ...
                <?php
                foreach (\backend\models\GoodsClass::find()->where(['p_id'=>0])->all() as $k0=>$v0){
                ...
                <div class="cat <?=$k0==0?"item1":""?>">
                    ...
                    <div class="cat_detail">
                        ...
                        <?php
                        foreach (\backend\models\GoodsClass::find()->where(['p_id'=>$v0->id])->all() as $k1=>$v1){
                        ...
                        <dl class="<?=$k0==0?"dl_1st":""?>">
                            ...
                            <dd>
                                ...
                                <?php
                                foreach (\backend\models\GoodsClass::find()->where(['p_id'=>$v1->id])->all() as $k2=>$v2){
