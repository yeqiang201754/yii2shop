		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="/list/content?id=<?=$good->id?>"><img src="<?=$good->logo?>" alt=""/></a></dt>
							<dd><a href="/list/content?id=<?=$good->id?>"><?=$good->title?></dt>
							<dd><strong>￥<?=$good->goods_price?></strong></dt>
							<dd><a href=""><em>已有<?=rand(100,1000)?>人评价</em></a></dt>
						</dl>
					</li>
<?php   } ?>
