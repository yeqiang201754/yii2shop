			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
                        ...
                        ?>
						<a href="<?=$goods->imgs[0]->name?>?imageView2/2/w/800" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goods->imgs[0]->name?>?imageView2/2/w/350" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                              <?php
                              foreach ($goods->imgs as $k=>$img){
                              ?>

								<li class="<?=$k>0?"":"cur"?>">
									<a class="<?=$k>0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->name?>?imageView2/2/w/350',largeimage: '<?=$img->name?>?imageView2/2/w/800'}"><img src="<?=$img->name?>?imageView2/2/w/50"></a>
								</li>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$goods->goods_price?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?=date('Y-m-d H:i:s',$goods->add_time)?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=rand(100,1000)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="<?=\yii\helpers\Url::to('/list/add-cart')?>" method="get" class="choose">
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<li><span>商品名称：</span><?=$goods->title?></li>
								<li><span>商品编号：</span><?=$goods->sn?></li>
								<li><span>品牌：</span><?=$goods->brand->name?></li>
								<li><span>上架时间：</span><?=date($goods->add_time)?></li>
					...
					<?php echo $goods->content->content;?>
					</div>
					<!-- 商品介绍 end -->
